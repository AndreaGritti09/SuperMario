...
var gravity = 0.6;
var friction = 0.8;
var livelloMax = 4780; // Lunghezza totale del livello modificata per l'esempio fisso
...
function startGame() {
   ...
   // --- SEZIONE 2: Zona Ostacoli Extra (1700 - 3500) ---
    ...
    myObstacles.push(new component(20, 400, "#FFD700", livelloMax, topPlatformY - 150, "rect")); 
...
function updateGameArea() {
    ...
    if (animatedObject.x >= livelloMax-50) {
        isGameOver = true;
        myGameArea.stop();
